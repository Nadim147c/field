module github.com/Nadim147c/field

go 1.25.0

require (
	github.com/Nadim147c/theme v0.0.1-alpha.1
...
replace github.com/charmbracelet/fang => github.com/Nadim147c/fang v0.4.4-0.20251001045336-b40804a797bd
